...
- **`br.mil.eb.gabcmt.sicoi.base`**: Reusable components and base classes for all features
...
- **`br.mil.eb.gabcmt.sicoi.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `br.mil.eb.gabcmt.sicoi` (e.g., `br.mil.eb.gabcmt.sicoi.myfeature`)
